...
declare const AttachTrafficSourcesCommand_base: {
    new (input: AttachTrafficSourcesCommandInput): import("@smithy/core/client").CommandImpl<AttachTrafficSourcesCommandInput, AttachTrafficSourcesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachTrafficSourcesCommandInput): import("@smithy/core/client").CommandImpl<AttachTrafficSourcesCommandInput, AttachTrafficSourcesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
