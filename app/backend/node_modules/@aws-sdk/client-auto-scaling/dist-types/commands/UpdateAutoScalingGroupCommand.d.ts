...
declare const UpdateAutoScalingGroupCommand_base: {
    new (input: UpdateAutoScalingGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateAutoScalingGroupCommandInput, UpdateAutoScalingGroupCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAutoScalingGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateAutoScalingGroupCommandInput, UpdateAutoScalingGroupCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
