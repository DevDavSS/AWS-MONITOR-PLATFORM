...
declare const DescribeLifecycleHookTypesCommand_base: {
    new (input: DescribeLifecycleHookTypesCommandInput): import("@smithy/core/client").CommandImpl<DescribeLifecycleHookTypesCommandInput, DescribeLifecycleHookTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLifecycleHookTypesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLifecycleHookTypesCommandInput, DescribeLifecycleHookTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
