...
declare const PutWarmPoolCommand_base: {
    new (input: PutWarmPoolCommandInput): import("@smithy/core/client").CommandImpl<PutWarmPoolCommandInput, PutWarmPoolCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutWarmPoolCommandInput): import("@smithy/core/client").CommandImpl<PutWarmPoolCommandInput, PutWarmPoolCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
