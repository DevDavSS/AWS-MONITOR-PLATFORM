...
declare const PutScheduledUpdateGroupActionCommand_base: {
    new (input: PutScheduledUpdateGroupActionCommandInput): import("@smithy/core/client").CommandImpl<PutScheduledUpdateGroupActionCommandInput, PutScheduledUpdateGroupActionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutScheduledUpdateGroupActionCommandInput): import("@smithy/core/client").CommandImpl<PutScheduledUpdateGroupActionCommandInput, PutScheduledUpdateGroupActionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
