...
declare const DescribeTerminationPolicyTypesCommand_base: {
    new (input: DescribeTerminationPolicyTypesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTerminationPolicyTypesCommandInput, DescribeTerminationPolicyTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTerminationPolicyTypesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTerminationPolicyTypesCommandInput, DescribeTerminationPolicyTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
