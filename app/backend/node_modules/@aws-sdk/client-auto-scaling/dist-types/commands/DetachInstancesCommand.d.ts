...
declare const DetachInstancesCommand_base: {
    new (input: DetachInstancesCommandInput): import("@smithy/core/client").CommandImpl<DetachInstancesCommandInput, DetachInstancesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachInstancesCommandInput): import("@smithy/core/client").CommandImpl<DetachInstancesCommandInput, DetachInstancesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
