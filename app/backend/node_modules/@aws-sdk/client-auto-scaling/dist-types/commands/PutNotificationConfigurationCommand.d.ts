...
declare const PutNotificationConfigurationCommand_base: {
    new (input: PutNotificationConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutNotificationConfigurationCommandInput, PutNotificationConfigurationCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutNotificationConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutNotificationConfigurationCommandInput, PutNotificationConfigurationCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
