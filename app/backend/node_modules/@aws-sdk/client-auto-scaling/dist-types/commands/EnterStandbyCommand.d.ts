...
declare const EnterStandbyCommand_base: {
    new (input: EnterStandbyCommandInput): import("@smithy/core/client").CommandImpl<EnterStandbyCommandInput, EnterStandbyCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnterStandbyCommandInput): import("@smithy/core/client").CommandImpl<EnterStandbyCommandInput, EnterStandbyCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
