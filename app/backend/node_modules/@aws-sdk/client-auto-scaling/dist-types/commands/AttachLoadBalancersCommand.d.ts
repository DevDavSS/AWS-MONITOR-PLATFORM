...
declare const AttachLoadBalancersCommand_base: {
    new (input: AttachLoadBalancersCommandInput): import("@smithy/core/client").CommandImpl<AttachLoadBalancersCommandInput, AttachLoadBalancersCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachLoadBalancersCommandInput): import("@smithy/core/client").CommandImpl<AttachLoadBalancersCommandInput, AttachLoadBalancersCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
