...
declare const RecordLifecycleActionHeartbeatCommand_base: {
    new (input: RecordLifecycleActionHeartbeatCommandInput): import("@smithy/core/client").CommandImpl<RecordLifecycleActionHeartbeatCommandInput, RecordLifecycleActionHeartbeatCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RecordLifecycleActionHeartbeatCommandInput): import("@smithy/core/client").CommandImpl<RecordLifecycleActionHeartbeatCommandInput, RecordLifecycleActionHeartbeatCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
