...
declare const CreateOrUpdateTagsCommand_base: {
    new (input: CreateOrUpdateTagsCommandInput): import("@smithy/core/client").CommandImpl<CreateOrUpdateTagsCommandInput, CreateOrUpdateTagsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateOrUpdateTagsCommandInput): import("@smithy/core/client").CommandImpl<CreateOrUpdateTagsCommandInput, CreateOrUpdateTagsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
