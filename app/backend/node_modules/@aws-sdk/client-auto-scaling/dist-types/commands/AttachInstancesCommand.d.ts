...
declare const AttachInstancesCommand_base: {
    new (input: AttachInstancesCommandInput): import("@smithy/core/client").CommandImpl<AttachInstancesCommandInput, AttachInstancesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachInstancesCommandInput): import("@smithy/core/client").CommandImpl<AttachInstancesCommandInput, AttachInstancesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
