...
declare const GetPredictiveScalingForecastCommand_base: {
    new (input: GetPredictiveScalingForecastCommandInput): import("@smithy/core/client").CommandImpl<GetPredictiveScalingForecastCommandInput, GetPredictiveScalingForecastCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPredictiveScalingForecastCommandInput): import("@smithy/core/client").CommandImpl<GetPredictiveScalingForecastCommandInput, GetPredictiveScalingForecastCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
