...
declare const SetInstanceHealthCommand_base: {
    new (input: SetInstanceHealthCommandInput): import("@smithy/core/client").CommandImpl<SetInstanceHealthCommandInput, SetInstanceHealthCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetInstanceHealthCommandInput): import("@smithy/core/client").CommandImpl<SetInstanceHealthCommandInput, SetInstanceHealthCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
