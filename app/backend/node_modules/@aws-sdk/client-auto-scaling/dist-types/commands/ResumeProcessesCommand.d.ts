...
declare const ResumeProcessesCommand_base: {
    new (input: ResumeProcessesCommandInput): import("@smithy/core/client").CommandImpl<ResumeProcessesCommandInput, ResumeProcessesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResumeProcessesCommandInput): import("@smithy/core/client").CommandImpl<ResumeProcessesCommandInput, ResumeProcessesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
