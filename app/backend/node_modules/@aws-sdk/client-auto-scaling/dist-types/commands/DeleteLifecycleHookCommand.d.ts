...
declare const DeleteLifecycleHookCommand_base: {
    new (input: DeleteLifecycleHookCommandInput): import("@smithy/core/client").CommandImpl<DeleteLifecycleHookCommandInput, DeleteLifecycleHookCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLifecycleHookCommandInput): import("@smithy/core/client").CommandImpl<DeleteLifecycleHookCommandInput, DeleteLifecycleHookCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
