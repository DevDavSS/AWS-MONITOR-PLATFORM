...
declare const ExecutePolicyCommand_base: {
    new (input: ExecutePolicyCommandInput): import("@smithy/core/client").CommandImpl<ExecutePolicyCommandInput, ExecutePolicyCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExecutePolicyCommandInput): import("@smithy/core/client").CommandImpl<ExecutePolicyCommandInput, ExecutePolicyCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
