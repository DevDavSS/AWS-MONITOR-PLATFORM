...
declare const DescribeWarmPoolCommand_base: {
    new (input: DescribeWarmPoolCommandInput): import("@smithy/core/client").CommandImpl<DescribeWarmPoolCommandInput, DescribeWarmPoolCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeWarmPoolCommandInput): import("@smithy/core/client").CommandImpl<DescribeWarmPoolCommandInput, DescribeWarmPoolCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
