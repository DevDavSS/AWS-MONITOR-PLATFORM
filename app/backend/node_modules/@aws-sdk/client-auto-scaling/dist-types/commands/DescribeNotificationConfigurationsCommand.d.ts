...
declare const DescribeNotificationConfigurationsCommand_base: {
    new (input: DescribeNotificationConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeNotificationConfigurationsCommandInput, DescribeNotificationConfigurationsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNotificationConfigurationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNotificationConfigurationsCommandInput, DescribeNotificationConfigurationsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
