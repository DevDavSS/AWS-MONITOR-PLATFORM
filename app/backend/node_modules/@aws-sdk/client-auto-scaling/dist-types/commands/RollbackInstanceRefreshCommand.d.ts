...
declare const RollbackInstanceRefreshCommand_base: {
    new (input: RollbackInstanceRefreshCommandInput): import("@smithy/core/client").CommandImpl<RollbackInstanceRefreshCommandInput, RollbackInstanceRefreshCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RollbackInstanceRefreshCommandInput): import("@smithy/core/client").CommandImpl<RollbackInstanceRefreshCommandInput, RollbackInstanceRefreshCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
