...
declare const DescribeAutoScalingGroupsCommand_base: {
    new (input: DescribeAutoScalingGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutoScalingGroupsCommandInput, DescribeAutoScalingGroupsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAutoScalingGroupsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAutoScalingGroupsCommandInput, DescribeAutoScalingGroupsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
