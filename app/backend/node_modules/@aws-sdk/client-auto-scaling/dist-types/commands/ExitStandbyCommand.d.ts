...
declare const ExitStandbyCommand_base: {
    new (input: ExitStandbyCommandInput): import("@smithy/core/client").CommandImpl<ExitStandbyCommandInput, ExitStandbyCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExitStandbyCommandInput): import("@smithy/core/client").CommandImpl<ExitStandbyCommandInput, ExitStandbyCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
