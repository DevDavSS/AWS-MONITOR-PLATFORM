...
declare const DescribeScalingProcessTypesCommand_base: {
    new (input: DescribeScalingProcessTypesCommandInput): import("@smithy/core/client").CommandImpl<DescribeScalingProcessTypesCommandInput, DescribeScalingProcessTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeScalingProcessTypesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeScalingProcessTypesCommandInput, DescribeScalingProcessTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
