...
declare const BatchDeleteScheduledActionCommand_base: {
    new (input: BatchDeleteScheduledActionCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteScheduledActionCommandInput, BatchDeleteScheduledActionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDeleteScheduledActionCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteScheduledActionCommandInput, BatchDeleteScheduledActionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
