...
declare const CreateAutoScalingGroupCommand_base: {
    new (input: CreateAutoScalingGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateAutoScalingGroupCommandInput, CreateAutoScalingGroupCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAutoScalingGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateAutoScalingGroupCommandInput, CreateAutoScalingGroupCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
