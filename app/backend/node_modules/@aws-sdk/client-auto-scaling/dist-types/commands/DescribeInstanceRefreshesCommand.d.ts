...
declare const DescribeInstanceRefreshesCommand_base: {
    new (input: DescribeInstanceRefreshesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceRefreshesCommandInput, DescribeInstanceRefreshesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeInstanceRefreshesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceRefreshesCommandInput, DescribeInstanceRefreshesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
