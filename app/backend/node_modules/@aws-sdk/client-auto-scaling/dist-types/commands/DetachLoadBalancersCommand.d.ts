...
declare const DetachLoadBalancersCommand_base: {
    new (input: DetachLoadBalancersCommandInput): import("@smithy/core/client").CommandImpl<DetachLoadBalancersCommandInput, DetachLoadBalancersCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachLoadBalancersCommandInput): import("@smithy/core/client").CommandImpl<DetachLoadBalancersCommandInput, DetachLoadBalancersCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
