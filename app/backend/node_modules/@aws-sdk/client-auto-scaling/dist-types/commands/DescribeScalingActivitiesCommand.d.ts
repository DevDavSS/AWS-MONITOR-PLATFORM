...
declare const DescribeScalingActivitiesCommand_base: {
    new (input: DescribeScalingActivitiesCommandInput): import("@smithy/core/client").CommandImpl<DescribeScalingActivitiesCommandInput, DescribeScalingActivitiesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeScalingActivitiesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeScalingActivitiesCommandInput, DescribeScalingActivitiesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
