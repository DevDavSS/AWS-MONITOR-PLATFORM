...
declare const DeleteWarmPoolCommand_base: {
    new (input: DeleteWarmPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteWarmPoolCommandInput, DeleteWarmPoolCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteWarmPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteWarmPoolCommandInput, DeleteWarmPoolCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
