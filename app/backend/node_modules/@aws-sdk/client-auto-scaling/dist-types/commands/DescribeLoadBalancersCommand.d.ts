...
declare const DescribeLoadBalancersCommand_base: {
    new (input: DescribeLoadBalancersCommandInput): import("@smithy/core/client").CommandImpl<DescribeLoadBalancersCommandInput, DescribeLoadBalancersCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeLoadBalancersCommandInput): import("@smithy/core/client").CommandImpl<DescribeLoadBalancersCommandInput, DescribeLoadBalancersCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
