...
declare const DescribeLoadBalancerTargetGroupsCommand_base: {
    new (input: DescribeLoadBalancerTargetGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLoadBalancerTargetGroupsCommandInput, DescribeLoadBalancerTargetGroupsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeLoadBalancerTargetGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLoadBalancerTargetGroupsCommandInput, DescribeLoadBalancerTargetGroupsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
