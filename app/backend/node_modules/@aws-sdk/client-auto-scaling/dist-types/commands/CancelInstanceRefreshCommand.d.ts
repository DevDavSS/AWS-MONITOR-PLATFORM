...
declare const CancelInstanceRefreshCommand_base: {
    new (input: CancelInstanceRefreshCommandInput): import("@smithy/core/client").CommandImpl<CancelInstanceRefreshCommandInput, CancelInstanceRefreshCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelInstanceRefreshCommandInput): import("@smithy/core/client").CommandImpl<CancelInstanceRefreshCommandInput, CancelInstanceRefreshCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
