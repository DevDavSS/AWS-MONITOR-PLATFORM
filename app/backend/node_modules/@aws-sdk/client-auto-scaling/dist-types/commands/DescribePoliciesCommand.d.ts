...
declare const DescribePoliciesCommand_base: {
    new (input: DescribePoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribePoliciesCommandInput, DescribePoliciesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribePoliciesCommandInput]): import("@smithy/core/client").CommandImpl<DescribePoliciesCommandInput, DescribePoliciesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
