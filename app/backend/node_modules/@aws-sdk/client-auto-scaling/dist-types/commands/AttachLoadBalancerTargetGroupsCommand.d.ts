...
declare const AttachLoadBalancerTargetGroupsCommand_base: {
    new (input: AttachLoadBalancerTargetGroupsCommandInput): import("@smithy/core/client").CommandImpl<AttachLoadBalancerTargetGroupsCommandInput, AttachLoadBalancerTargetGroupsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachLoadBalancerTargetGroupsCommandInput): import("@smithy/core/client").CommandImpl<AttachLoadBalancerTargetGroupsCommandInput, AttachLoadBalancerTargetGroupsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
