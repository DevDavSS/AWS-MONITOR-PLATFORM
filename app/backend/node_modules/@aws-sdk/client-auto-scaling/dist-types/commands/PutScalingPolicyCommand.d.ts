...
declare const PutScalingPolicyCommand_base: {
    new (input: PutScalingPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutScalingPolicyCommandInput, PutScalingPolicyCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutScalingPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutScalingPolicyCommandInput, PutScalingPolicyCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
