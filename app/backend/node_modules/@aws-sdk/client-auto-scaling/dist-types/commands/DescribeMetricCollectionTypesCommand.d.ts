...
declare const DescribeMetricCollectionTypesCommand_base: {
    new (input: DescribeMetricCollectionTypesCommandInput): import("@smithy/core/client").CommandImpl<DescribeMetricCollectionTypesCommandInput, DescribeMetricCollectionTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeMetricCollectionTypesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeMetricCollectionTypesCommandInput, DescribeMetricCollectionTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
