...
declare const SetDesiredCapacityCommand_base: {
    new (input: SetDesiredCapacityCommandInput): import("@smithy/core/client").CommandImpl<SetDesiredCapacityCommandInput, SetDesiredCapacityCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetDesiredCapacityCommandInput): import("@smithy/core/client").CommandImpl<SetDesiredCapacityCommandInput, SetDesiredCapacityCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
