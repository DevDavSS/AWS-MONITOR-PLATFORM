...
declare const LaunchInstancesCommand_base: {
    new (input: LaunchInstancesCommandInput): import("@smithy/core/client").CommandImpl<LaunchInstancesCommandInput, LaunchInstancesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: LaunchInstancesCommandInput): import("@smithy/core/client").CommandImpl<LaunchInstancesCommandInput, LaunchInstancesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
