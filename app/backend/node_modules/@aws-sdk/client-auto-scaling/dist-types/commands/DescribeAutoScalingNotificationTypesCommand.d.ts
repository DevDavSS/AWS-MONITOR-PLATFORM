...
declare const DescribeAutoScalingNotificationTypesCommand_base: {
    new (input: DescribeAutoScalingNotificationTypesCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutoScalingNotificationTypesCommandInput, DescribeAutoScalingNotificationTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAutoScalingNotificationTypesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAutoScalingNotificationTypesCommandInput, DescribeAutoScalingNotificationTypesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
