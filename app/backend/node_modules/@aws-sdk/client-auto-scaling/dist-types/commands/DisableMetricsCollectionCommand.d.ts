...
declare const DisableMetricsCollectionCommand_base: {
    new (input: DisableMetricsCollectionCommandInput): import("@smithy/core/client").CommandImpl<DisableMetricsCollectionCommandInput, DisableMetricsCollectionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableMetricsCollectionCommandInput): import("@smithy/core/client").CommandImpl<DisableMetricsCollectionCommandInput, DisableMetricsCollectionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
