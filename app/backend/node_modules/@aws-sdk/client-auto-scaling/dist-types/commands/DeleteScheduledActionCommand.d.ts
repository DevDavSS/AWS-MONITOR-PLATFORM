...
declare const DeleteScheduledActionCommand_base: {
    new (input: DeleteScheduledActionCommandInput): import("@smithy/core/client").CommandImpl<DeleteScheduledActionCommandInput, DeleteScheduledActionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteScheduledActionCommandInput): import("@smithy/core/client").CommandImpl<DeleteScheduledActionCommandInput, DeleteScheduledActionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
