...
declare const StartInstanceRefreshCommand_base: {
    new (input: StartInstanceRefreshCommandInput): import("@smithy/core/client").CommandImpl<StartInstanceRefreshCommandInput, StartInstanceRefreshCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartInstanceRefreshCommandInput): import("@smithy/core/client").CommandImpl<StartInstanceRefreshCommandInput, StartInstanceRefreshCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
