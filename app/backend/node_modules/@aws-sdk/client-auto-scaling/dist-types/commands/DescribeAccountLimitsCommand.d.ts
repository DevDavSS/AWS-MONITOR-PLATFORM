...
declare const DescribeAccountLimitsCommand_base: {
    new (input: DescribeAccountLimitsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAccountLimitsCommandInput, DescribeAccountLimitsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAccountLimitsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAccountLimitsCommandInput, DescribeAccountLimitsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
