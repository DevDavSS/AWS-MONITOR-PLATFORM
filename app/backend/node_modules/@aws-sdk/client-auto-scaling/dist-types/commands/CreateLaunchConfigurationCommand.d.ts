...
declare const CreateLaunchConfigurationCommand_base: {
    new (input: CreateLaunchConfigurationCommandInput): import("@smithy/core/client").CommandImpl<CreateLaunchConfigurationCommandInput, CreateLaunchConfigurationCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLaunchConfigurationCommandInput): import("@smithy/core/client").CommandImpl<CreateLaunchConfigurationCommandInput, CreateLaunchConfigurationCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
