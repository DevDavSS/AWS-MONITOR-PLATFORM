...
declare const DescribeLifecycleHooksCommand_base: {
    new (input: DescribeLifecycleHooksCommandInput): import("@smithy/core/client").CommandImpl<DescribeLifecycleHooksCommandInput, DescribeLifecycleHooksCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeLifecycleHooksCommandInput): import("@smithy/core/client").CommandImpl<DescribeLifecycleHooksCommandInput, DescribeLifecycleHooksCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
