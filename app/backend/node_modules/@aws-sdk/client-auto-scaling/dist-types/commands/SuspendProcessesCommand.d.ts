...
declare const SuspendProcessesCommand_base: {
    new (input: SuspendProcessesCommandInput): import("@smithy/core/client").CommandImpl<SuspendProcessesCommandInput, SuspendProcessesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SuspendProcessesCommandInput): import("@smithy/core/client").CommandImpl<SuspendProcessesCommandInput, SuspendProcessesCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
