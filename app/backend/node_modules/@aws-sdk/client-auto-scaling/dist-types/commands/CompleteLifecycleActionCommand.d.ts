...
declare const CompleteLifecycleActionCommand_base: {
    new (input: CompleteLifecycleActionCommandInput): import("@smithy/core/client").CommandImpl<CompleteLifecycleActionCommandInput, CompleteLifecycleActionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CompleteLifecycleActionCommandInput): import("@smithy/core/client").CommandImpl<CompleteLifecycleActionCommandInput, CompleteLifecycleActionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
