...
declare const DeleteLaunchConfigurationCommand_base: {
    new (input: DeleteLaunchConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteLaunchConfigurationCommandInput, DeleteLaunchConfigurationCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLaunchConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteLaunchConfigurationCommandInput, DeleteLaunchConfigurationCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
