...
declare const DescribeLaunchConfigurationsCommand_base: {
    new (input: DescribeLaunchConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLaunchConfigurationsCommandInput, DescribeLaunchConfigurationsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLaunchConfigurationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLaunchConfigurationsCommandInput, DescribeLaunchConfigurationsCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
