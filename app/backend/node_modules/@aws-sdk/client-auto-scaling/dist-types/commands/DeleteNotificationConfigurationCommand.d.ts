...
declare const DeleteNotificationConfigurationCommand_base: {
    new (input: DeleteNotificationConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteNotificationConfigurationCommandInput, DeleteNotificationConfigurationCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteNotificationConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteNotificationConfigurationCommandInput, DeleteNotificationConfigurationCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
