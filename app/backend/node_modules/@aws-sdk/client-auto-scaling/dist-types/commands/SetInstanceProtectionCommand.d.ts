...
declare const SetInstanceProtectionCommand_base: {
    new (input: SetInstanceProtectionCommandInput): import("@smithy/core/client").CommandImpl<SetInstanceProtectionCommandInput, SetInstanceProtectionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetInstanceProtectionCommandInput): import("@smithy/core/client").CommandImpl<SetInstanceProtectionCommandInput, SetInstanceProtectionCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
