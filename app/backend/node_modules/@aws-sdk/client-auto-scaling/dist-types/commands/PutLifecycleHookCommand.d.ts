...
declare const PutLifecycleHookCommand_base: {
    new (input: PutLifecycleHookCommandInput): import("@smithy/core/client").CommandImpl<PutLifecycleHookCommandInput, PutLifecycleHookCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutLifecycleHookCommandInput): import("@smithy/core/client").CommandImpl<PutLifecycleHookCommandInput, PutLifecycleHookCommandOutput, import("..").AutoScalingClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
